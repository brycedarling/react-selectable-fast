    ...
    function(e, t, o) {
      ...
      t.default = function(e) {
        ...
        return (
          ...
          (t.defaultProps = { selected: !1, wasSelected: !1 }),
              ...
              (o.clearSelection = function() {
                ...
                try {
                  for (
                    ...
                    var l = r.value
                    l.setState({ selected: !1, wasSelected: !1 }), o.selectedItems.delete(l)
                  }
                } catch (e) {
                  ;(t = !0), (n = e)
                } finally {
                  ...
                  if (!o.mouseMoved && (0, c.default)(t.target, o.rootNode)) o.handleClick(t, n, r)
                    ...
                    try {
                      for (
                        ...
                        var f = a.value
                        27 === f.props.file.id && console.log('wasSelected', !0),
                ...
                value: function(e, t, o, n, r, s) {
                  ...
                  if (n && l)
                    return (
                      ...
                      27 === e.props.file.id && console.log('wasSelected', a),
                  ...
                  if (!n && l) {
                    if (a && r && (!this.selectionStarted || s))
                      return (
                        27 === e.props.file.id && console.log('wasSelected', !0),
                    ...
                    if (!c && !a && d)
                      return (
                        27 === e.props.file.id && console.log('wasSelected', !1),
